...
;(function ($) {
  ...
  $.fn.perfectScrollbar = function (suppliedSettings, option) {
    ...
    var updateContentScrollTop = function () {
      var scroll_top = parseInt(
        (scrollbar_y_top * content_height) / container_height,
        10,
      )
    ...
    var updateContentScrollLeft = function () {
      var scroll_left = parseInt(
        (scrollbar_x_left * content_width) / container_width,
        10,
      )
    ...
    var updateBarSizeAndPosition = function () {
      ...
      if (container_width < content_width) {
        scrollbar_x_width = parseInt(
          (container_width * container_width) / content_width,
          10,
        )
        scrollbar_x_left = parseInt(
          ($this.scrollLeft() * container_width) / content_width,
          10,
        )
      } else {
        scrollbar_x_width = 0
      ...
      if (container_height < content_height) {
        scrollbar_y_height = parseInt(
          (container_height * container_height) / content_height,
          10,
        )
        scrollbar_y_top = parseInt(
          ($this.scrollTop() * container_height) / content_height,
          10,
        )
      } else {
