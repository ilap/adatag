...
export const SERVER_URL = "http://localhost:1442";
export const BOOTSTRAP_SLOT = 76;
export const SAFETY_SLOTS = 100 // FIXME: 13 * 20 * 10;
export const POLICY_ID = "ded23baa0e1e8874cdaaa970301af7ba5f2eecfd583275e44b5dee9f";
...
INSERT INTO v (xi, xa, xb) VALUES ( '0', 't',  'v');
INSERT INTO u (xi, xa, xb) VALUES ( '0', 'u',  'w');
...
export const appendUpdateQuery = (tableName: string, element: string) => `
BEGIN TRANSACTION;
