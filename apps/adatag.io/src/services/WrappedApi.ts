import { AbstractWallet, Address, C, coreToUtxo, Delegation, fromHex, Payload, RewardAddress, SignedMessage, toHex, Transaction, Translucent, TxHash, UTxO } from "translucent-cardano";
import { BrowserWallet } from '@meshsdk/core'



  export class WrappedWallet implements AbstractWallet {

    api: BrowserWallet;
      translucent: any;
  
    constructor(translucent: Translucent, api: BrowserWallet) {
    ...
    async getUtxos(): Promise<UTxO[]> {
      ...
      //});
      //return utxos;
      return await this.api.getUtxos()
    }
