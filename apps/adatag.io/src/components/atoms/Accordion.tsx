  ...
  return (
    <div className="flex justify-center border border-gray-300 mt-6 mb-6 rounded-[56px] w-full">
      <div className="w-full m-12 lg:max-w-[860px] md:max-w-[640px] sm:max-w-[400px]">
        <div className="flex text-left items-center -mx-16 p-4 cursor-pointer" onClick={() => setIsActive(!isActive)}>
          <motion.div
          ...
          <div className="text-4xl  mx-10 font-medium tracking-tighter">{title}</div>
        </div>
        {isActive && (
          <motion.div
            initial="closed"
