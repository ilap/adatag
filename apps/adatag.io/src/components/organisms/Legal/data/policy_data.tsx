...
export const data = [
  {
    ...
    content: (
      <>
        <p>
          Welcome to Adatag ("Adatag", "we", "us" and "our"), the platform offering NFT-based username (adatag) minting
          services through our website, adatag.io (hereinafter referred to as the "Service"). This Privacy Policy will
          help you understand how we collect, use and share your data and assist you in exercising the privacy rights
          available to you.
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Service refers to the Adatag.io website, which allows users to mint unique, human-readable NFTs (non-fungible
          tokens) called "adatags" on the Cardano blockchain. These adatags can be used to identify a user's wallet for
          receiving funds and are decentralized, free, instant, public, and transparent.
        </p>
        ...
        <p>
          ...
          physiological, genetic, mental, economic, cultural or social identity. For the purposes of the CCPA, Personal
          Data means any information that identifies, relates to, describes or is capable of being associated with, or
        ...
        <p>
          ...
          which such individual is accessing or using the Service, as applicable. Under GDPR (General Data Protection
          Regulation), You can be referred to as the Data Subject or as the User as you are the individual using the
          Service.
        </p>
      </>
    ),
        ...
        <ul className="list-disc">
          <li>
            <p>
              ...
              users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked
              for cannot be provided, and We only use these Cookies to provide You with those services.
            </p>
          </li>
          <li>
            <p>
              Cookies Policy / Notice Acceptance Cookies (Persistent Cookies): These Cookies identify if users have
              accepted the use of cookies on the Website.
            </p>
          </li>
          <li>
            <p>
              Functionality Cookies (Persistent Cookies): These Cookies allow us to remember choices You make when You
          ...
          <li>
            <p>
              ...
              traffic to the Website and how users use the Website. The information gathered via these Cookies may
              directly or indirectly identify you as an individual visitor. This is because the information collected is
              typically linked to a pseudonymous identifier associated with the device you use to access the Website. We
              may also use these Cookies to test new pages, features or new functionality of the Website to see how our
              users react to them.
            </p>
          </li>
        </ul>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Adatag will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>Adatag may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul className="list-disc">
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          If you are a resident of the European Economic Area (EEA), you have certain data protection rights. Adatag
        ...
        <ul className="list-disc">
          <li>
            <p>
              The right to access, update or to delete the information we have on you. Whenever made possible, you can
              access, update or request deletion of your Personal Data directly within your account settings section. If
              you are unable to perform these actions yourself, please contact us to assist you.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              The right to withdraw consent. You also have the right to withdraw your consent at any time where Adatag
    ...
    content: (
      <>
        ...
        <p>
          ...
          <a href="http://www.google.com/intl/en/policies/privacy/" target="_blank" rel="noopener noreferrer">
