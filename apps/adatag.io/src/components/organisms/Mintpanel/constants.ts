...
export const mintguideline =
  'Max 16 chars, starts with letter, ends with letter/digit. Lowercase letters, digits, and symbols (-, _, .). '

export const claimguideline =
  'You can only claim a deposit 20 days after minting and if you are the original minter of the adatag.'

export const timelockTooltip = `To prevent misuse of the system, 
a timelock deposit is implemented,
which can be always redeemed by the minter
after 20 days of the minting.`
