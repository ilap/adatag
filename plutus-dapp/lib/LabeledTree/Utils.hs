...
module LabeledTree.Utils where
...
update :: BuiltinByteString -> LabeledTree -> Maybe LabeledTree
...
-- ghci> import LabeledTree.Tree
-- ghci> import Data.Maybe (fromMaybe)
-- ghci> :set -XOverloadedStrings
-- ghci> proof $ fromMaybe LabeledEmpty $ findNodeByVal sampleTree (LabeledTree.Tree.Val "g" "h")
-- c39e8c972fa8
-- ghci> import LabeledTree.Tree
-- ghci> :set -XOverloadedStrings
